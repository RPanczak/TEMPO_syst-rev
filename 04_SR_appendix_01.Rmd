...
main <- read_excel("TEMPO_SR_2019-06-01.xlsx", sheet = "Main") %>% 
  replace(is.na(.), "") %>% 
...
variables <- read_excel("TEMPO_SR_2019-06-01.xlsx", sheet = "Variables_short") %>% 
  replace(is.na(.), "")
# View(variables)

applications <- read_excel("TEMPO_SR_2019-06-01.xlsx", sheet = "Related") %>% 
  replace(is.na(.), "")
# View(applications)
...
## Type, country, region, purpose and data of applied studies
...
## Other characteristics of of applied studies
