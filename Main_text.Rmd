...
csl: bibliography/population-research-and-policy-review.csl
bibliography:
...
The review was conducted using the principles of the PRISMA Statement for Reporting Systematic Reviews [@moherPreferredReportingItems2009] (_Appendix 1_). In order to deal with complexity and lack of standardization in the field and to account for theory-building character of this work we additionally adopted "mixed-method review" methodology [@goughQualitativeMixedMethods2015]. This approach allowed us to combine methods of a systematic review (e.g. selection of keywords and sources, eligibility criteria) with the openness and flexibility of traditional reviews. No review protocol was used in this study.
...
*Note:* The first category used. Box width is proportional to the total number of studies. Studies that did not report on an estimated population size using the size of dataset whenever possible.
