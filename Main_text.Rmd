...
- various methodologies of crowd estimation and event monitoring such as classic approaches to demonstration population counts [@yipEstimationNumberPeople2010], agent-based modelling [@chowCrowdsourcingGeocomputationalFramework2018] approaches based on social media [@simsApplicationSocialMedia2017; @bottaMeasuringSizeCrowd2019] or mobile phone [@mameiEstimatingAttendanceCellular2016] data, bluetooth device monitoring [@versicheleUseBluetoothAnalysing2012];
